      ...
      <div className="md:container md:mx-auto mt-36 max-md:mt-16 mb-20 max-md:mx-10 footer flex items-start md:flex-row flex-col">
        <div className="flex items-end flex-cols md:w-1/4 w-full">
          <div className="footer-info">
            <p>Blooming Rooms began its journey with the iconic Blooming Inn in Shillong, providing warm hospitality in the heart of nature. Since then, we've expanded to three more locations, spreading our charm to Guwahati and Goa. Each of our hotels reflects the same dedication to comfort, offering a unique and memorable experience in every stay.</p>
